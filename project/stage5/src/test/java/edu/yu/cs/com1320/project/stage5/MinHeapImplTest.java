...
public class MinHeapImplTest {
    ...
    public void testReheapifyMoveUp() {
        ...
        Document doc1 = new DocumentImpl(uri1, "Hi my name is Jeremy");
        URI uri2 = URI.create("http://www.github.com/jwizenf2");
        Document doc2 = new DocumentImpl(uri2, "Hi my name is Jeremy");
        URI uri3 = URI.create("http://www.github.com/jwizenf3");
        Document doc3 = new DocumentImpl(uri3, "Hi my name is Jeremy");
        heap.insert(doc1);
        heap.insert(doc2);
        heap.insert(doc3);
